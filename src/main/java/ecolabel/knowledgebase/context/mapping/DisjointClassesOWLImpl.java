...
*/
public class DisjointClassesOWLImpl extends MappingOWLImpl {
	...
	public void renderMappingImpl(Node nl, BinaryMappingComponent bmc) {
		...
		bmc.mappingType.setSelectedItem("DisjointClasses");//xd set the selected mapping type 
		bmc.lbMappingType.setText("DisjointClasses");
	...
	public Element buildRealBinaryMappingImpl(BinaryMappingComponent bmc, Document doc) {
		...
		eleClassA2.setAttribute("IRI", getEntityIRIFromTooltip(bmc.tfHead.getToolTipText()));
		Element eleClassB2 = doc.createElement("Class");
		eleClassB2.setAttribute("IRI", getEntityIRIFromTooltip(bmc.tfTail.getToolTipText()));
