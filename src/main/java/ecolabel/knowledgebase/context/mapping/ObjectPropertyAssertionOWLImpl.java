...
public class ObjectPropertyAssertionOWLImpl extends MappingOWLImpl {
	...
	public void renderMappingImpl(Node nl, BinaryMappingComponent bmc) {
		...
		bmc.mappingType.setSelectedItem("ObjectPropertyAssertion");//xd set the selected mapping type 
		bmc.lbMappingType.setText("ObjectPropertyAssertion");
	...
	public Element buildRealBinaryMappingImpl(BinaryMappingComponent bmc, Document doc) {
		...
		eleObjectProperty.setAttribute("IRI", getEntityIRIFromTooltip(bmc.mapping.getToolTipText()));
		Element eleIndividual1 = doc.createElement("NamedIndividual");
		eleIndividual1.setAttribute("IRI", getEntityIRIFromTooltip(bmc.tfHead.getToolTipText()));
		Element eleIndividual2 = doc.createElement("NamedIndividual");
		eleIndividual2.setAttribute("IRI", getEntityIRIFromTooltip(bmc.tfTail.getToolTipText()));
