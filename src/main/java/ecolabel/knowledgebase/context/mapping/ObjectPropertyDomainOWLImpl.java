 ...
 */
public class ObjectPropertyDomainOWLImpl extends MappingOWLImpl {
	...
	public void renderMappingImpl(Node nl, BinaryMappingComponent bmc) {
		...
		bmc.mappingType.setSelectedItem("ObjectPropertyDomain");//xd set the selected mapping type 
		bmc.lbMappingType.setText("ObjectPropertyDomain");
	...
	public Element buildRealBinaryMappingImpl(BinaryMappingComponent bmc, Document doc) {
		...
		eleObjectProperty4.setAttribute("IRI", getEntityIRIFromTooltip(bmc.tfHead.getToolTipText()));
		Element eleClass3 = doc.createElement("Class");
		eleClass3.setAttribute("IRI", getEntityIRIFromTooltip(bmc.tfTail.getToolTipText()));
