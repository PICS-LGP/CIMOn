...
public class TargetOntologyView extends /*AbstractOWLViewComponent*/JPanel {
    ...
    public void itemStateChanged(ItemEvent itemEvent) {
	    ...
	    System.out.println("\n  Item State Changed! " + ens.entityIRI + "(" + ens.entityId.getText() + ")" );
    ...
    public TargetOntologyView(ContextSkeletonView csv){
...
//    }
	...
	public void updateEntityListHandler(){
		...
		if(contextSkeletonView.getSourceOntologyView().getOntologiesList().getSelectedItem().equals(ontologiesList.getSelectedItem())){
			contextSkeletonView.getSourceOntologyView().updateEntityList();
		}
